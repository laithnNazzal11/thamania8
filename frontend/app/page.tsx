                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-6">
                      {trendingPodcasts.map((podcast, index) => (
                        <div key={podcast.id} className="group">
                          ...
                          <h3 className={`text-gray-400 font-semibold text-sm mb-1 truncate`}>
                            {podcast.track_name}
                          </h3>
                          <p className={`${getRandomColor()} text-xs truncate ${getRandomColor()}`}>
                            {podcast.artist_name}
                          </p>
                        </div>
                      ))}
